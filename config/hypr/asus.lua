...
hl.bind(mainMod .. " + CONTROL + K", hl.dsp.exec_cmd("~/.local/bin/scripts/keyboard-theme-sync.sh"))
hl.bind(mainMod .. " + CONTROL + SHIFT + K", hl.dsp.exec_cmd("~/.local/bin/scripts/keyboard-led-off.sh"))
hl.bind("XF86TouchpadToggle", hl.dsp.exec_cmd("~/.local/bin/scripts/touchpad-toggle.sh"), { locked = true })
hl.bind(mainMod .. " + CONTROL + G", hl.dsp.exec_cmd("~/.local/bin/scripts/gpu-toggle.sh"))
hl.bind(mainMod .. " + CONTROL + B", hl.dsp.exec_cmd("~/.local/bin/scripts/battery-status.sh"))
